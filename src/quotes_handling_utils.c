...
/*   Updated: 2025/10/31 17:02:50 by jlager           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	return (counts.single_sections == 1 && counts.double_sections == 0
...
{
	return (counts.double_sections == 1 && counts.single_sections == 0
		&& counts.unquoted_sections == 0);
}
